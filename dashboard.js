// =============================================
// SpotAlert Dashboard – AWS Connected
// =============================================
...
let alertIntervalMinutes = 60; // default 1 hour
...
// =====================================
// MANUAL CAMERA UPLOAD (Trigger AWS Detection)
// =====================================
if (uploadForm) {
...
async function checkBackend() {
  try {
    ...
    else console.warn("⚠️ Backend not responding");
  } catch {
