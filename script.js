...
// =====================================================
// 🔗 LIVE BACKEND CONNECTION (FINAL)
// =====================================================
const API_BASE_URL =
  window.location.hostname.includes("spotalert.live")
    ? "https://api.spotalert.live"      // Caddy/HTTPS backend
    : "http://34.228.115.166:3000";     // EC2 fallback (direct PM2)
